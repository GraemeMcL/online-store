package net.secexp.store.repository;

import net.secexp.store.StoreApp;
import net.secexp.store.config.Constants;
import net.secexp.store.config.audit.AuditEventConverter;
import net.secexp.store.domain.PersistentAuditEvent;
...
import static net.secexp.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
